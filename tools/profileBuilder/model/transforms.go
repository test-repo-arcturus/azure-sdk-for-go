		...
		go func(pd string) {
			filepath.Walk(pd, func(path string, info os.FileInfo, err error) error {
				...
				for pn := range packages {
					...
					// becomes github.com/test-repo-arcturus/azure-sdk-for-go/profiles/2017-03-09/compute/mgmt/compute
...
// limitations under the License.`)
	...
	fmt.Fprintln(generatorStampBuilder, "// github.com/test-repo-arcturus/azure-sdk-for-go/tools/profileBuilder")
