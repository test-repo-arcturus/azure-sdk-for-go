...
import (
	"context"
	"github.com/test-repo-arcturus/azure-sdk-for-go/services/trafficmanager/mgmt/2018-04-01/trafficmanager"
)
...
type UserMetricsKeysClientAPI interface {
	CreateOrUpdate(ctx context.Context) (result trafficmanager.UserMetricsModel, err error)
	Delete(ctx context.Context) (result trafficmanager.DeleteOperationResult, err error)
	Get(ctx context.Context) (result trafficmanager.UserMetricsModel, err error)
}
