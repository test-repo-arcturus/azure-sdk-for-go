...
import (
	"context"
	"github.com/test-repo-arcturus/azure-sdk-for-go/services/consumption/mgmt/2018-06-30/consumption"
...
type CostTagsClientAPI interface {
	CreateOrUpdate(ctx context.Context, billingAccountID string, parameters consumption.CostTag) (result consumption.CostTag, err error)
	Get(ctx context.Context, billingAccountID string) (result consumption.CostTag, err error)
}
...
type AggregatedCostClientAPI interface {
	GetByManagementGroup(ctx context.Context, managementGroupID string) (result consumption.ManagementGroupAggregatedCostResult, err error)
