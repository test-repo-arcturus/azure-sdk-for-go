...
import (
	...
	"github.com/test-repo-arcturus/azure-sdk-for-go/services/servicefabric/7.0/servicefabric"
)

// BaseClientAPI contains the set of methods on the BaseClient type.
type BaseClientAPI interface {
	AddConfigurationParameterOverrides(ctx context.Context, nodeName string, configParameterOverrideList []servicefabric.ConfigParameterOverride, force *bool, timeout *int64) (result autorest.Response, err error)
	...
	GetClusterLoad(ctx context.Context, timeout *int64) (result servicefabric.ClusterLoadInfo, err error)
	...
	GetConfigurationOverrides(ctx context.Context, nodeName string, timeout *int64) (result servicefabric.ListConfigParameterOverride, err error)
	...
	GetImageStoreFolderSize(ctx context.Context, contentPath string, timeout *int64) (result servicefabric.FolderSizeInfo, err error)
	GetImageStoreInfo(ctx context.Context, timeout *int64) (result servicefabric.ImageStoreInfo, err error)
	GetImageStoreRootContent(ctx context.Context, timeout *int64) (result servicefabric.ImageStoreContent, err error)
	GetImageStoreRootFolderSize(ctx context.Context, timeout *int64) (result servicefabric.FolderSizeInfo, err error)
	...
	GetUnplacedReplicaInformation(ctx context.Context, serviceID string, partitionID *uuid.UUID, onlyQueryPrimaries *bool, timeout *int64) (result servicefabric.UnplacedReplicaInformation, err error)
	...
	MovePrimaryReplica(ctx context.Context, partitionID uuid.UUID, nodeName string, ignoreConstraints *bool, timeout *int64) (result autorest.Response, err error)
	MoveSecondaryReplica(ctx context.Context, partitionID uuid.UUID, currentNodeName string, newNodeName string, ignoreConstraints *bool, timeout *int64) (result autorest.Response, err error)
	...
	RemoveConfigurationOverrides(ctx context.Context, nodeName string, timeout *int64) (result autorest.Response, err error)
	...
	ReportReplicaHealth(ctx context.Context, partitionID uuid.UUID, replicaID string, serviceKind servicefabric.ReplicaHealthReportServiceKind, healthInformation servicefabric.HealthInformation, immediate *bool, timeout *int64) (result autorest.Response, err error)
	...
	ToggleVerboseServicePlacementHealthReporting(ctx context.Context, enabled bool, timeout *int64) (result autorest.Response, err error)
...
type MeshApplicationClientAPI interface {
	...
	GetUpgradeProgress(ctx context.Context, applicationResourceName string) (result servicefabric.ApplicationResourceUpgradeProgressInfo, err error)
