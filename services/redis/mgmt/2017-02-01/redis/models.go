...
const fqdn = "github.com/test-repo-arcturus/azure-sdk-for-go/services/redis/mgmt/2017-02-01/redis"
...
// LinkedServerList list of linked server Ids of a Redis cache.
type LinkedServerList struct {
	// Value - List of linked server Ids of a Redis cache.
