...
import (
	"context"
	"github.com/test-repo-arcturus/azure-sdk-for-go/services/preview/managedservices/mgmt/2019-04-01/managedservices"
...
type RegistrationDefinitionsClientAPI interface {
	CreateOrUpdate(ctx context.Context, registrationDefinitionID string, APIVersion string, scope string, requestBody managedservices.RegistrationDefinition) (result managedservices.RegistrationDefinitionsCreateOrUpdateFuture, err error)
...
type RegistrationAssignmentsClientAPI interface {
	CreateOrUpdate(ctx context.Context, scope string, registrationAssignmentID string, APIVersion string, requestBody managedservices.RegistrationAssignment) (result managedservices.RegistrationAssignmentsCreateOrUpdateFuture, err error)
	Delete(ctx context.Context, scope string, registrationAssignmentID string, APIVersion string) (result managedservices.RegistrationAssignmentsDeleteFuture, err error)
