...
import (
	"context"
	"github.com/test-repo-arcturus/azure-sdk-for-go/services/preview/timeseriesinsights/mgmt/2017-02-28-preview/timeseriesinsights"
...
type EnvironmentsClientAPI interface {
	...
	Get(ctx context.Context, resourceGroupName string, environmentName string) (result timeseriesinsights.EnvironmentResource, err error)
