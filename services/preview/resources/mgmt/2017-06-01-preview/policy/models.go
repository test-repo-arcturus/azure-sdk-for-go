...
const fqdn = "github.com/test-repo-arcturus/azure-sdk-for-go/services/preview/resources/mgmt/2017-06-01-preview/policy"
...
// ErrorResponse error response indicates ARM is not able to process the incoming request. The reason is
